...
Written by Timo Rantalainen 2013 - 2018 tjrantal at gmail dot com. Contributions taken from the Apache commongs math 3.0 git clone http://git-wip-us.apache.org/repos/asf/commons-math.git, which is licensed under the Apache 2.0 license, which also applies to this project.
